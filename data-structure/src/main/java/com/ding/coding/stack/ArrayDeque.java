...
public class ArrayDeque<E> implements Deque<E> {
     ...
     */
    public ArrayDeque() {
        // 堆栈的数据结构是以 2 的次幂进行初始化,扩容时候为 2 的倍数
    ...
    public E pop() {
        ...
        System.out.println("pop.idx {} = {} & {}" + head + Integer.toBinaryString(h + 1) + Integer.toBinaryString(elements.length - 1));
        return result;
    }
